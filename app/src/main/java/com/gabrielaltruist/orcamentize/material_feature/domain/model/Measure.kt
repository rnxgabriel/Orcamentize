...
sealed class Measure {
     ...
     */
    data class Quantity(val quantity: Int) : Measure()
     ...
     */
    data class M2(val height: Double, val width: Double) : Measure()
     ...
     */
    data class M3(val height: Double, val width: Double, val depth: Double) : Measure()
}
